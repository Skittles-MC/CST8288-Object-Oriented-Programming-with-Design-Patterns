...
//	}
	...
	final void testPoint(){
			...
			//fail();//TODO
//		DoubleProperty p1 = new SimpleDoubleProperty();
...
//		assertEquals(p1, p2);
	...
	final void testPointDoubleDouble(){
		...
		assertNotEquals(11, p1.x());
		assertNotEquals(12, p2.y());
	...
	final void testUnbind(){
		...
		p2 = new Point(16,17);
		assertNotEquals(p1, p2);
		assertNotEquals(14, p1.x());
		assertNotEquals(15, p1.x());
		assertNotEquals(16, p2.y());
		assertNotEquals(17, p2.y());
	}
	...
	final void testTranslate(){
		...
		assertNotEquals(p1, p2);
		assertNotEquals(14, p1.x());
		assertNotEquals(17, p1.x());
		assertNotEquals(16, p2.y());
		assertNotEquals(19, p2.y());
	}
	...
	final void testMoveDoubleDouble(){
		...
		p2.move(8, 9);
		assertEquals(p1, p2);
		assertNotEquals(8, p1.x());
		assertNotEquals(9, p1.x());
		assertNotEquals(8, p2.y());
		assertEquals(9, p2.y());
		p1.unbind();
		p1.move(6, 7);
		p2.move(8, 9);
	...
	final void testMovePoint(){
		...
		assertNotEquals(p1, p2);
		assertNotEquals(6, p1.x());
		assertNotEquals(7, p1.x());
		assertNotEquals(8, p2.y());
		assertNotEquals(9, p2.y());
	}
	...
	final void testSet(){
		...
		Point p2 = new Point(12,13);
		p1.bind(p2);
		assertThrows(Exception.class, ()-> p1.set(12, 13));
	}
